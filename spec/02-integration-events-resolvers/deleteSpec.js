describe('Deletng an event', () => {
    ...
    it('with valid mutation should pass', () => {
        ...
        let response = mutators.deleteEvent(undefined, args);
    ...
    it('that does not exist should fail', () => {
        ...
        expect( () => { mutators.deleteEvent(undefined, args); } ).toThrow(
            `Cannot delete event "${args.name}" because it doesn't exist.`
        );
    });
});